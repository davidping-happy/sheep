...
const GITHUB =
  'https://github.com/davidping-happy/sheep/releases/download/v1.1.5-preview/churchsheep-1.1.5.apk';
const EXPO =
  'https://expo.dev/artifacts/eas/ZLn45qzvTrD11p5MDZ2mm7cFiZmR8F-NMylHE3MWFHc.apk';
const RELEASE =
  'https://github.com/davidping-happy/sheep/releases/tag/v1.1.5-preview';
