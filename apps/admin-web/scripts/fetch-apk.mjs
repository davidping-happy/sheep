...
const APK_URL =
  ...
  'https://github.com/davidping-happy/sheep/releases/download/v1.1.12-preview/churchsheep-1.1.12.apk';
const FILE_NAME = process.env.APK_FILE_NAME || 'churchsheep-1.1.12.apk';
